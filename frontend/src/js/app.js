...
function openRegisterModal() { renderRegistrationStep1(); new bootstrap.Modal(document.getElementById('registerCompanyModal')).show(); }
function renderRegistrationStep1() {
    ...
    document.getElementById('reg-step-1').addEventListener('submit', requestOtp);
}
